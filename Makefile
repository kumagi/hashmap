...
hashtest.o:hashtest.cc hashmap.h marked_ptr.h locks.h
	$(CXX) -c $< -o $@ $(OPTS) $(WARNS)
insert_bench.o:insert_bench.cc marked_ptr.h hashmap.h locks.h
	$(CXX) -c $< -o $@ -O4 -g $(WARNS) -fno-inline -pg 
insert_bench_cov.o:insert_bench.cc marked_ptr.h hashmap.h locks.h
